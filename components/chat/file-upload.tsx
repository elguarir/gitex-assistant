...
function FileUpload({ onFilesAdded, children, multiple = true, accept }: FileUploadProps) {
  ...
  return context?.isDragging ? (
    <div
      className={cn(
        ...
        'animate-in ease-in-out duration-300 fade-in-0 slide-in-from-bottom-10 zoom-in-90',
        className
      )}
      {...props}
    />
